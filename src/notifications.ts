...
export function seedNotificationTestState(
  kind:
    | "empty"
    | "one"
    | "many"
        ...
        : kind === "reply"
          ? [
              base(
                ...
                18,
                "/mailbox/my/sample-waiting-letter-one",
              ),
            ]
          : kind === "progress"
            ? [
            ...
            : kind === "report"
              ? [
                  base(
                    "report_resolved",
                    "신고 처리 결과를 알려드려요.",
                    "안전하게 살펴본 결과를 나의 공간에서 확인할 수 있어요.",
                    90,
                    "/safety-management",
                  ),
                ]
              : kind === "missing"
                ? [
                    base(
                      "reply_arrived",
                      "답장이 도착했어요.",
                      "이 알림과 연결된 내용을 더 이상 볼 수 없어요.",
                      120,
                      "/mailbox/my/missing-letter",
                    ),
                  ]
                : [
                    base(
                    ...
                    base(
                      ...
                      80,
                      "/write-reply/sample-waiting-letter-two",
                    ),
                    base(
                      "service_notice",
                      "공감편지에서 알려드려요",
